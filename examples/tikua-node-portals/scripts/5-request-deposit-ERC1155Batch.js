...
const hashApprove = await tikua.approveBatchERC1155(tokenAddress, true);
await publicClient.waitForTransactionReceipt({ hash: hashApprove });
console.log('Approved')

const hash = await tikua.depositBatchERC1155(tokenAddress, [0, 1], [10, 10], stringToHex('test'), stringToHex('test2'));
...
console.log('Token 1 Owner:',
    await publicClient.readContract({
        ...
        args: ['0xab7528bb862fB57E8A2BCd567a2e929a0Be56a5e', '1']
    })
)